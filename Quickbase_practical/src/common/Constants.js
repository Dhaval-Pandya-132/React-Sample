...
export const JSON_KEY_CHOICES = "choices";
...
export const FIELD_KEY_CHOICE = "choicesVal";
export const FIELD_KEY_ORDER = "orderVal";

export const CHOICES_DELIMITER = "\n";

export const MAX_CHOICES_LIMIT = 50;

export const OPTIONS_ARRAY = [
    {
    displayLabel: "Display choices in Alphabetical",
    value: "ASC"
    },
    {
        displayLabel: "Display choices in reverse Alphabetical",
        value: "DESC"
    }];
